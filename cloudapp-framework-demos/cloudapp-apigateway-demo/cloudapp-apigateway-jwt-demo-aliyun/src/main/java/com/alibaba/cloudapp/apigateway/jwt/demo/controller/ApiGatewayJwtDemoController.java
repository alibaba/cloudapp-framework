...
package com.alibaba.cloudapp.apigateway.jwt.demo.controller;
...
@RestController
@RequestMapping("/jwt")
public class ApiGatewayJwtDemoController {

    private static final Logger logger = LoggerFactory.getLogger(ApiGatewayJwtDemoController.class);
