...
package com.alibaba.cloudapp.apigateway.oauth2.demo.controller;
...
public class ApiGatewayOauth2DemoController {

    private static final Logger logger = LoggerFactory.getLogger(ApiGatewayOauth2DemoController.class);
